...
savepath = "WS_list_single_dir/"
# Load data
X_train = np.load("latentspace_locations/trainingset_fake_B_latentspace.npy")
X_testA = np.load("latentspace_locations/testset_fake_A_latentspace.npy")
X_testB = np.load("latentspace_locations/testset_fake_B_latentspace.npy")
X_animals = np.load("latentspace_locations/animals_fake_B_latentspace.npy")
X_Exp = np.load("latentspace_locations/exp_fake_B_latentspace.npy")
X_franken = np.load("latentspace_locations/franken_fake_B_latentspace.npy")
X_Rb2MnF4 = np.load("latentspace_locations/Rb2MnF4_fake_B_latentspace.npy")
X_Nore = np.load("latentspace_locations/sim_ref_Nore_fake_B_latentspace.npy")
X_TobyFit = np.load("latentspace_locations/sim_ref_TobyFit_fake_B_latentspace.npy")
X_Digits = np.load("latentspace_locations/Digits_fake_B_latentspace.npy")
