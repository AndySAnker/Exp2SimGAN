...
model_s.load_state_dict(torch.load('../../train_model/TobyFit_fake/uq-discrim-newer-71.pt',map_location=torch.device('cpu')))
save_path = "save_masked_files_All_balanced/"

print ("trained_models_balanced_percentile0p2clip-model71")
