...
Goodenough_images = sorted(glob.glob("../../../../../datasets/goodenoughANDdimer/trainB/Goodenough*"))
Dimer_images = sorted(glob.glob("../../../../../datasets/goodenoughANDdimer/trainB/Dimer*"))
...
def log_results(trainer):
    ...
    torch.save(model.state_dict(), 'trained_models_balanced_percentile0p5clip/uq-discrim-newer-'+str(trainer.state.epoch)+'.pt') 
