...
class Downsample1D(nn.Module):
    def __init__(self, channels, pad_type='reflect', filt_size=3, stride=2, pad_off=0):
        ...
        filt = get_filter1D(filt_size=self.filt_size)
        self.register_buffer('filt', filt[None, None, :].repeat((self.channels, 1, 1)))

        self.pad = get_pad_layer1D(pad_type)(self.pad_sizes)
...
class Upsample1D(nn.Module):
    def __init__(self, channels, pad_type='repl', filt_size=4, stride=2):
        ...
        filt = get_filter1D(filt_size=self.filt_size) * (stride**2)
        self.register_buffer('filt', filt[None, None, :].repeat((self.channels, 1, 1)))

        self.pad = get_pad_layer1D(pad_type)([1, 1])
...
class Upsample3D(nn.Module):
    def __init__(self, channels, pad_type='repl', filt_size=4, stride=2):
        ...
        self.pad = get_pad_layer3D(pad_type)([1, 1, 1, 1, 1, 1])
...
def define_G_1D(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    """
    net = None
    norm_layer = get_norm_layer1D(norm_type=norm)

    if netG == 'resnet_9blocks':
        net = ResnetGenerator1D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=9, opt=opt)
    elif netG == 'resnet_6blocks':
        net = ResnetGenerator1D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=6, opt=opt)
    elif netG == 'resnet_4blocks':
        net = ResnetGenerator1D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=4, opt=opt)
    else:
...
def define_G_3D(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
             init_gain=0.02, no_antialias=False, no_antialias_up=False, gpu_ids=[], opt=None):
    """Create a generator
    ...
    if netG == 'resnet_9blocks':
        net = ResnetGenerator3D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=9, opt=opt)
    elif netG == 'resnet_6blocks':
        net = ResnetGenerator3D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=6, opt=opt)
    elif netG == 'resnet_4blocks':
        net = ResnetGenerator3D(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, no_antialias=no_antialias, no_antialias_up=no_antialias_up, n_blocks=4, opt=opt)
    elif netG == 'unet_128':
...
def define_F_1D(input_nc, netF, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    if netF == 'global_pool':
        net = PoolingF()
    elif netF == 'reshape':
        net = ReshapeF()
        ...
        net = PatchSampleF1D(use_mlp=False, init_type=init_type, init_gain=init_gain, gpu_ids=gpu_ids, nc=opt.netF_nc)
    elif netF == 'mlp_sample':
        net = PatchSampleF1D(use_mlp=True, init_type=init_type, init_gain=init_gain, gpu_ids=gpu_ids, nc=opt.netF_nc)
...
def define_F_3D(input_nc, netF, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    if netF == 'global_pool':
        net = PoolingF()
    elif netF == 'reshape':
        net = ReshapeF()
...
def define_D_1D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    ...
    if netD == 'basic':  # default PatchGAN classifier
        net = NLayerDiscriminator1D(input_nc, ndf, n_layers=3, norm_layer=norm_layer, no_antialias=no_antialias,)
    elif netD == 'n_layers':  # more options
        net = NLayerDiscriminator1D(input_nc, ndf, n_layers_D, norm_layer=norm_layer, no_antialias=no_antialias,)
    else:
...
def define_D_3D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    """Create a discriminator
    ...
    if netD == 'basic':  # default PatchGAN classifier
        ...
        net = NLayerDiscriminator3D(input_nc, ndf, n_layers_D, norm_layer=norm_layer, no_antialias=no_antialias,)
    else:
        raise NotImplementedError('Discriminator model name [%s] is not recognized' % netD)
    """
    The following models are not implemented yet
...
class PatchSampleF1D(nn.Module):
    def __init__(self, use_mlp=False, init_type='normal', init_gain=0.02, nc=256, gpu_ids=[]):
        # potential issues: currently, we use the same patch_ids for multiple images in the batch
        super(PatchSampleF1D, self).__init__()
        self.l2norm = Normalize(2)
    ...
    def forward(self, feats, num_patches=64, patch_ids=None):
        ...
        for feat_id, feat in enumerate(feats):
            ...
            feat_reshape = feat.permute(0, 2, 1).flatten(1, 1)
            if num_patches > 0:
...
class ResnetGenerator1D(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm1d, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False, opt=None):
        ...
        """
        assert(n_blocks >= 0)
        super(ResnetGenerator1D, self).__init__()
        self.opt = opt
        ...
        for i in range(n_downsampling):  # add downsampling layers
            ...
            if(no_antialias):
                ...
                model += [nn.Conv1d(ngf * mult, ngf * mult * 2, kernel_size=3, stride=1, padding=1, bias=use_bias),
                          norm_layer(ngf * mult * 2),
                          nn.ReLU(True),
...
class ResnetGenerator(nn.Module):
    ...
    def forward(self, input, layers=[], encode_only=False):
        ...
        if len(layers) > 0:
            ...
            """Standard forward"""
            fake = self.model(input) # I wanted to run it without squeeze but got a 5D error.
            return fake
...
class ResnetGenerator3D(nn.Module):
    ...
    def forward(self, input, layers=[], encode_only=False):
        #input = torch.zeros((2,3,40,40,40))
        if -1 in layers:
            layers.append(len(self.model))
        if len(layers) > 0:
            feat = input
...
class NLayerDiscriminator3D(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm3d, no_antialias=False):
        ...
        sequence += [nn.Conv3d(ndf * nf_mult, 2, kernel_size=kw, stride=1, padding=padw)]  # output 1 channel prediction map
        self.model = nn.Sequential(*sequence)
