...
class Unaligned1DDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        print ("\n >>> WARNING: You are using the 1D model loader, which does not have any functionalities regarding preprocessing the data. Therefore, you must do this before loading the data. <<< \n")
